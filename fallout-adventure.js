...
class FalloutAdventure {
    constructor() {
        ...
        // Character Systema// FALLOUT: Wasteland Chronicles - Text Adventure Game Engine
class FalloutAdventure {
    constructor() {
        this.gameState = 'menu';
        this.gameTime = 0;
        ...
        // Game Data - Initialize NPCs first so they can be referenced in locations
    ...
    initializeLocations() {
        return {
            ...
            megaton: {
                ...
                items: [],
                npcs: [
                    this.npcs.lucasSimms,
                    this.npcs.moiraBrown
                ],
                enemies: []
            },
            megatonmarket: {
